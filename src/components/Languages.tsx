      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {LANGUAGES_DATA.map((lang, index) => (
          <div
            ...
            className="glass-panel p-6 rounded-2xl border border-cyan-500/30 hover:border-cyan-400 hover:shadow-[0_0_25px_rgba(0,240,255,0.2)] transition-all duration-300 flex items-center gap-5 relative group cursor-pointer"
          >
